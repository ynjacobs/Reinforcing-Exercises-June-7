...
# [print(key)for key in project.keys()]
...
how_many_tracks = len(tracks)

total_length = 0
for track in tracks:
    total_length += track["duration_in_milliseconds"]
print('the total duration of the playlist is' ,total_length/1000, 'seconds')